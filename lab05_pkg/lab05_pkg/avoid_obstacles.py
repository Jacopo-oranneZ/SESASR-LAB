...
class ObstacleAvoidanceNode(Node):
    def __init__(self):
        ...
        self.csv_filename = os.path.join(self.log_dir, f'task1_data_{timestamp_str}.csv')
        self.txt_filename = os.path.join(self.log_dir, f'task1_report_{timestamp_str}.txt')
        ...
        # Scriviamo l'header
        self.csv_writer.writerow(['timestamp', 'dist_to_goal', 'bearing_error', 'min_obstacle_dist', 'v_cmd', 'w_cmd', 'is_tracking', 'is_visible','goal_reached'])
    ...
    def velocity_command(self):
        ...
        for ind_v, v in enumerate(v_range):
            for ind_w, w in enumerate(w_range):
                ...
                total_scores[score_index] = head_score + vel_score + obs_score
        ...
        self.get_logger().info(f" Head:{head_score:.2f} Vel:{vel_score:.2f} Obs:{obs_score:.2f}")
    ...
    def go_to_pose(self):
        ...
        goal_reached_flag = dist < self.OPTIMAL_DIST
        ...
        self.update_metrics(dist, float(best_u[0]), float(best_u[1]), target_visible, goal_reached_flag)
    ...
    def update_metrics(self, current_dist, v, w, target_visible, goal_reached):
        """
       ...
       # Tracking
        ...
        self.csv_writer.writerow([timestamp, current_dist, bearing_error, current_min, v, w, is_tracking, int(target_visible), int(goal_reached)])
    ...
    def save_final_report(self):
        ...
        report = (
            ...
            f"Goal Reaches: {self.goal_reaches}\n"
